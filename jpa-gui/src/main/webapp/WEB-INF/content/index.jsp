...
<s:i18n name="Utenti">
  <s:form action="/prova.action" method="POST">
    <s:actionerror />
 	<s:textfield  key="currentUser.nome" name="currentUser.nome" label="il tuo nome" />
    <s:textfield  key="currentUser.cognome" name="currentUser.cognome" label="il tuo cognome"/>
    <s:textfield  key="currentUser.email" name="currentUser.email" label="la tua email"/>
